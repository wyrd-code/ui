  ...
  <WuiDialog v-model="isDialogVisible" title="Sign up" size="sm">
    <template #actions>
      <WuiButton
        ...
        variant="primary"
        block
        @click="isNestedModalVisible = true"
      >
  ...
  >
    <template #actions>
      <WuiButton
        ...
        size="lg"
        variant="primary"
        @click=";(isNestedModalVisible = false), (hasAcceptedTerms = true)"
      >
        I agree
      </WuiButton>
    </template>
    ...
    <div class="">
      <div class="prose mx-auto">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ACME LLC, Paris.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>By email: office@acme.com</li>
        </ul>
      </div>
    </div>
  </WuiDialog>
