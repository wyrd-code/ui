...
const isFieldVueComponent = (field: FormFieldSchema): field is FormFieldSchemaVueComponent => !!(field as any).component
...
export default defineComponent({
  ...
  setup({ schema }) {
    const buildVNodeFromFormFieldSchema = (field: FormFieldSchema, nested: any[]) => {
    ...
    const recursiveRender = (fields: FormSchema) => fields.reduce((body, field) => {
