<template>
  ...
  <pre>
          <code class="language-html">&lt;article class="prose"&gt;
  ...
  <ul>
    <li>
      ...
      <p>
        ...
        honestly, you could make a strong argument that you just shouldn't write
        this way.
      </p>
    </li>
    <li>
      ...
      <p>
        ...
        wouldn't be a list if it only had one item, and we really want this to
        look realistic. That's why I've added this second list item so I
    ...
    <li>
      ...
      <p>
        ...
        is definitely not worse, and since I seem to be having no trouble making
        up arbitrary things to type, I might as well include it.
      </p>
    </li>
  </ul>
  <p>
...
plugins: [],
    ...
    <li>
      ...
      <ul>
        <li>
          ...
          you are just creating a gross shape on the screen that is hard to
          read.
        </li>
        <li>
  ...
  <p>
    ...
    <code>&lt;p&gt;</code> tag unless there are multiple paragraphs in the list
